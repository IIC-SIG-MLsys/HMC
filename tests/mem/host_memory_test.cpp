...
protected:
    ...
    void SetUp() override {
        host_mem_ops = new Memory(0, MemoryType::CPU);
    }
...
TEST_F(HostMemoryTest, CopyHostToDevice_HappyPath) {
    ...
    EXPECT_EQ(host_mem_ops->copyHostToDevice(destination, source, sizeof(source)), status_t::SUCCESS);
...
TEST_F(HostMemoryTest, CopyHostToDevice_Nullptr) {
    char source[] = "Hello, World!";
    EXPECT_EQ(host_mem_ops->copyHostToDevice(nullptr, source, sizeof(source)), status_t::ERROR);
    char destination[20] = {0};
    EXPECT_EQ(host_mem_ops->copyHostToDevice(destination, nullptr, sizeof(source)), status_t::ERROR);
}
...
TEST_F(HostMemoryTest, CopyDeviceToHost_HappyPath) {
    char source[] = "Hello, World!";
    char destination[20] = {0};
    EXPECT_EQ(host_mem_ops->copyDeviceToHost(destination, source, sizeof(source)), status_t::SUCCESS);
    EXPECT_STREQ(destination, "Hello, World!");
}
...
TEST_F(HostMemoryTest, CopyDeviceToHost_Nullptr) {
    char source[] = "Hello, World!";
    EXPECT_EQ(host_mem_ops->copyDeviceToHost(nullptr, source, sizeof(source)), status_t::ERROR);
    char destination[20] = {0};
    EXPECT_EQ(host_mem_ops->copyDeviceToHost(destination, nullptr, sizeof(source)), status_t::ERROR);
}
...
TEST_F(HostMemoryTest, CopyDeviceToDevice_HappyPath) {
    char source[] = "Hello, World!";
    char destination[20] = {0};
    EXPECT_EQ(host_mem_ops->copyDeviceToDevice(destination, source, sizeof(source)), status_t::SUCCESS);
    EXPECT_STREQ(destination, "Hello, World!");
}
...
TEST_F(HostMemoryTest, CopyDeviceToDevice_Nullptr) {
    char source[] = "Hello, World!";
    EXPECT_EQ(host_mem_ops->copyDeviceToDevice(nullptr, source, sizeof(source)), status_t::ERROR);
    char destination[20] = {0};
    EXPECT_EQ(host_mem_ops->copyDeviceToDevice(destination, nullptr, sizeof(source)), status_t::ERROR);
}
