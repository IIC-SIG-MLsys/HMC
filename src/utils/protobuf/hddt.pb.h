...
struct TableStruct_hddt_2eproto {
  ...
  static const ::PROTOBUF_NAMESPACE_ID::internal::ParseTable
      schema[11] PROTOBUF_SECTION_VARIABLE(protodesc_cold);
...
extern CommunicationTaskDefaultTypeInternal
...
extern ComputationGraph_RankAssignmentDefaultTypeInternal
...
extern ComputationGraph_RankAssignment_DependencyMapEntry_DoNotUseDefaultTypeInternal
...
extern ComputationGraph_RankHostMappingEntry_DoNotUseDefaultTypeInternal
...
extern RankInfoCollectionDefaultTypeInternal
    _RankInfoCollection_default_instance_;
class SynchronizationTask;
class SynchronizationTaskDefaultTypeInternal;
extern SynchronizationTaskDefaultTypeInternal
...
PROTOBUF_NAMESPACE_OPEN
template <>
::hddt::CommunicationTask *
Arena::CreateMaybeMessage<::hddt::CommunicationTask>(Arena *);
template <>
::hddt::ComputationGraph *
Arena::CreateMaybeMessage<::hddt::ComputationGraph>(Arena *);
template <>
::hddt::ComputationGraph_RankAssignment *
Arena::CreateMaybeMessage<::hddt::ComputationGraph_RankAssignment>(Arena *);
template <>
...
template <>
::hddt::ComputeTask *Arena::CreateMaybeMessage<::hddt::ComputeTask>(Arena *);
template <>
::hddt::RankInfo *Arena::CreateMaybeMessage<::hddt::RankInfo>(Arena *);
template <>
::hddt::RankInfoCollection *
Arena::CreateMaybeMessage<::hddt::RankInfoCollection>(Arena *);
template <>
::hddt::SynchronizationTask *
Arena::CreateMaybeMessage<::hddt::SynchronizationTask>(Arena *);
template <>::hddt::Task *Arena::CreateMaybeMessage<::hddt::Task>(Arena *);
template <>
::hddt::TaskChain *Arena::CreateMaybeMessage<::hddt::TaskChain>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace hddt {
...
enum ComputeTask_OperatorType : int {
  ...
  ComputeTask_OperatorType_ComputeTask_OperatorType_INT_MIN_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  ComputeTask_OperatorType_ComputeTask_OperatorType_INT_MAX_SENTINEL_DO_NOT_USE_ =
      std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool ComputeTask_OperatorType_IsValid(int value);
constexpr ComputeTask_OperatorType ComputeTask_OperatorType_OperatorType_MIN =
    ComputeTask_OperatorType_REDUCE;
constexpr ComputeTask_OperatorType ComputeTask_OperatorType_OperatorType_MAX =
    ComputeTask_OperatorType_COPY;
constexpr int ComputeTask_OperatorType_OperatorType_ARRAYSIZE =
    ComputeTask_OperatorType_OperatorType_MAX + 1;
...
inline const std::string &ComputeTask_OperatorType_Name(T enum_t_value) {
  static_assert(
      ::std::is_same<T, ComputeTask_OperatorType>::value ||
...
inline bool ComputeTask_OperatorType_Parse(const std::string &name,
                                           ComputeTask_OperatorType *value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<
      ComputeTask_OperatorType>(ComputeTask_OperatorType_descriptor(), name,
                                value);
}
// ===================================================================

class RankInfo PROTOBUF_FINAL : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:hddt.RankInfo)
                                                                         */
{
public:
  ...
  RankInfo(RankInfo &&from) noexcept : RankInfo() { *this = ::std::move(from); }
  ...
  static inline const RankInfo *internal_default_instance() {
    return reinterpret_cast<const RankInfo *>(&_RankInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages = 0;

  friend void swap(RankInfo &a, RankInfo &b) { a.Swap(&b); }
...
private:
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
        &::descriptor_table_hddt_2eproto);
    return ::descriptor_table_hddt_2eproto
...
public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_hostname(std::string *hostname);
...
public:
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_ip_address(std::string *ip_address);
...
public:
  ...
  friend void swap(RankInfoCollection &a, RankInfoCollection &b) { a.Swap(&b); }
...
public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::hddt::RankInfo> *mutable_infos();
...
public:
  ...
  CommunicationTask(CommunicationTask &&from) noexcept : CommunicationTask() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(CommunicationTask &a, CommunicationTask &b) { a.Swap(&b); }
...
class ComputeTask PROTOBUF_FINAL : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:hddt.ComputeTask)
                                                                            */
{
public:
  ...
  ComputeTask(ComputeTask &&from) noexcept : ComputeTask() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(ComputeTask &a, ComputeTask &b) { a.Swap(&b); }
...
public:
  ...
  static constexpr OperatorType REDUCE = ComputeTask_OperatorType_REDUCE;
  static constexpr OperatorType COPY = ComputeTask_OperatorType_COPY;
  ...
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED(
      ...
      "    string fields are deprecated and will be removed in a"
      "    future release.")
  void unsafe_arena_set_allocated_dtype(std::string *dtype);
...
class Task PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:hddt.Task) */ {
public:
  inline Task() : Task(nullptr){};
  virtual ~Task();

  Task(const Task &from);
  Task(Task &&from) noexcept : Task() { *this = ::std::move(from); }
  ...
  static inline const Task *internal_default_instance() {
    return reinterpret_cast<const Task *>(&_Task_default_instance_);
  }
  ...
  inline Task *New() const final { return CreateMaybeMessage<Task>(nullptr); }
...
public:
  void
  unsafe_arena_set_allocated_comm_task(::hddt::CommunicationTask *comm_task);
...
public:
  void
  unsafe_arena_set_allocated_compute_task(::hddt::ComputeTask *compute_task);
...
public:
  void
  unsafe_arena_set_allocated_sync_task(::hddt::SynchronizationTask *sync_task);
...
class TaskChain PROTOBUF_FINAL : public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:hddt.TaskChain)
                                                                          */
{
public:
  ...
  TaskChain(TaskChain &&from) noexcept : TaskChain() {
    *this = ::std::move(from);
  }
  ...
  static inline const TaskChain *internal_default_instance() {
    return reinterpret_cast<const TaskChain *>(&_TaskChain_default_instance_);
  }
  static constexpr int kIndexInFileMessages = 6;

  friend void swap(TaskChain &a, TaskChain &b) { a.Swap(&b); }
...
public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::hddt::Task> *mutable_tasks();
...
public:
  ...
  ::hddt::Task *add_tasks();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::hddt::Task> &tasks() const;
...
class ComputationGraph_RankAssignment_DependencyMapEntry_DoNotUse
    : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT32, 0> {
public:
  ...
  static const ComputationGraph_RankAssignment_DependencyMapEntry_DoNotUse *
  internal_default_instance() {
    return reinterpret_cast<
        const ComputationGraph_RankAssignment_DependencyMapEntry_DoNotUse *>(
        &_ComputationGraph_RankAssignment_DependencyMapEntry_DoNotUse_default_instance_);
  }
...
{
public:
  inline ComputationGraph_RankAssignment()
      : ComputationGraph_RankAssignment(nullptr){};
  ...
  ComputationGraph_RankAssignment(
      ComputationGraph_RankAssignment &&from) noexcept
      : ComputationGraph_RankAssignment() {
    *this = ::std::move(from);
  }

  inline ComputationGraph_RankAssignment &
  operator=(const ComputationGraph_RankAssignment &from) {
    CopyFrom(from);
    return *this;
  }
  inline ComputationGraph_RankAssignment &
  operator=(ComputationGraph_RankAssignment &&from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from)
        InternalSwap(&from);
    } else {
  ...
  static void InitAsDefaultInstance(); // FOR INTERNAL USE ONLY
  static inline const ComputationGraph_RankAssignment *
  internal_default_instance() {
  ...
  friend void swap(ComputationGraph_RankAssignment &a,
                   ComputationGraph_RankAssignment &b) {
    a.Swap(&b);
  }
...
protected:
  explicit ComputationGraph_RankAssignment(
      ::PROTOBUF_NAMESPACE_ID::Arena *arena);
...
private:
  const ::PROTOBUF_NAMESPACE_ID::Map<::PROTOBUF_NAMESPACE_ID::int32,
                                     ::PROTOBUF_NAMESPACE_ID::int32> &
  _internal_dependency_map() const;
  ::PROTOBUF_NAMESPACE_ID::Map<::PROTOBUF_NAMESPACE_ID::int32,
                               ::PROTOBUF_NAMESPACE_ID::int32> *
...
class ComputationGraph_RankHostMappingEntry_DoNotUse
    : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<
          ...
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT32,
          ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING, 0> {
public:
  typedef ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<
      ComputationGraph_RankHostMappingEntry_DoNotUse,
      ::PROTOBUF_NAMESPACE_ID::int32, std::string,
  ...
  static const ComputationGraph_RankHostMappingEntry_DoNotUse *
  internal_default_instance() {
    return reinterpret_cast<
        const ComputationGraph_RankHostMappingEntry_DoNotUse *>(
        &_ComputationGraph_RankHostMappingEntry_DoNotUse_default_instance_);
  }
  static bool ValidateKey(void *) { return true; }
...
public:
  ...
  ComputationGraph(ComputationGraph &&from) noexcept : ComputationGraph() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(ComputationGraph &a, ComputationGraph &b) { a.Swap(&b); }
...
private:
  const ::hddt::ComputationGraph_RankAssignment &
  _internal_assignments(int index) const;
...
// int32 rank = 1;
inline void RankInfo::clear_rank() { rank_ = 0; }
...
inline void RankInfo::set_hostname(const char *value, size_t size) {
...
inline std::string *RankInfo::unsafe_arena_release_hostname() {
  ...
  return hostname_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void
RankInfo::unsafe_arena_set_allocated_hostname(std::string *hostname) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (hostname != nullptr) {

  } else {
  }
  hostname_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      hostname, GetArena());
...
inline void RankInfo::set_ip_address(const char *value, size_t size) {
...
inline std::string *RankInfo::unsafe_arena_release_ip_address() {
  ...
  return ip_address_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void
RankInfo::unsafe_arena_set_allocated_ip_address(std::string *ip_address) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (ip_address != nullptr) {

  } else {
  }
  ip_address_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ip_address, GetArena());
...
// int64 timestamp = 4;
inline void RankInfo::clear_timestamp() { timestamp_ = PROTOBUF_LONGLONG(0); }
...
inline void
RankInfo::_internal_set_timestamp(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void RankInfoCollection::clear_infos() { infos_.Clear(); }
...
inline const ::hddt::RankInfo &
RankInfoCollection::_internal_infos(int index) const {
...
// int32 target_rank = 1;
inline void CommunicationTask::clear_target_rank() { target_rank_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32
CommunicationTask::_internal_target_rank() const {
  return target_rank_;
}
...
inline void CommunicationTask::_internal_set_target_rank(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {

  target_rank_ = value;
}
inline void
CommunicationTask::set_target_rank(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
CommunicationTask::_internal_ptr_offset() const {
  return ptr_offset_;
}
...
inline void CommunicationTask::_internal_set_ptr_offset(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {

  ptr_offset_ = value;
}
inline void
CommunicationTask::set_ptr_offset(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
CommunicationTask::_internal_data_size() const {
  return data_size_;
}
...
inline void CommunicationTask::_internal_set_data_size(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {

  data_size_ = value;
}
inline void
CommunicationTask::set_data_size(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
// .hddt.ComputeTask.OperatorType op_type = 1;
inline void ComputeTask::clear_op_type() { op_type_ = 0; }
...
inline void
ComputeTask::_internal_set_op_type(::hddt::ComputeTask_OperatorType value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
ComputeTask::_internal_ptr_offset() const {
  return ptr_offset_;
}
...
inline void
ComputeTask::_internal_set_ptr_offset(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void
ComputeTask::_internal_set_data_size(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void ComputeTask::_internal_set_dtype(const std::string &value) {
  ...
  dtype_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
             value, GetArena());
}
...
inline void ComputeTask::set_dtype(const char *value, size_t size) {
...
inline void ComputeTask::set_allocated_dtype(std::string *dtype) {
  ...
  dtype_.SetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), dtype,
      GetArena());
...
inline std::string *ComputeTask::unsafe_arena_release_dtype() {
  ...
  return dtype_.UnsafeArenaRelease(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ComputeTask::unsafe_arena_set_allocated_dtype(std::string *dtype) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (dtype != nullptr) {

  } else {
  }
  dtype_.UnsafeArenaSetAllocated(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), dtype,
      GetArena());
...
inline void SynchronizationTask::clear_wait_ranks() { wait_ranks_.Clear(); }
inline ::PROTOBUF_NAMESPACE_ID::int32
SynchronizationTask::_internal_wait_ranks(int index) const {
  return wait_ranks_.Get(index);
}
inline ::PROTOBUF_NAMESPACE_ID::int32
SynchronizationTask::wait_ranks(int index) const {
  // @@protoc_insertion_point(field_get:hddt.SynchronizationTask.wait_ranks)
  return _internal_wait_ranks(index);
}
inline void
SynchronizationTask::set_wait_ranks(int index,
                                    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  wait_ranks_.Set(index, value);
  // @@protoc_insertion_point(field_set:hddt.SynchronizationTask.wait_ranks)
}
inline void SynchronizationTask::_internal_add_wait_ranks(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  wait_ranks_.Add(value);
}
inline void
SynchronizationTask::add_wait_ranks(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
SynchronizationTask::_internal_sequence_number() const {
  return sequence_number_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64
SynchronizationTask::sequence_number() const {
  // @@protoc_insertion_point(field_get:hddt.SynchronizationTask.sequence_number)
  return _internal_sequence_number();
}
inline void SynchronizationTask::_internal_set_sequence_number(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {

  sequence_number_ = value;
}
inline void
SynchronizationTask::set_sequence_number(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline bool Task::has_comm_task() const { return _internal_has_comm_task(); }
inline void Task::set_has_comm_task() { _oneof_case_[0] = kCommTask; }
...
inline const ::hddt::CommunicationTask &Task::_internal_comm_task() const {
  return _internal_has_comm_task()
             ...
             : *reinterpret_cast<::hddt::CommunicationTask *>(
...
inline void Task::unsafe_arena_set_allocated_comm_task(
...
inline ::hddt::CommunicationTask *Task::_internal_mutable_comm_task() {
  if (!_internal_has_comm_task()) {
    ...
    set_has_comm_task();
    task_type_.comm_task_ =
        CreateMaybeMessage<::hddt::CommunicationTask>(GetArena());
  }
...
inline void Task::set_has_compute_task() { _oneof_case_[0] = kComputeTask; }
...
inline const ::hddt::ComputeTask &Task::_internal_compute_task() const {
  return _internal_has_compute_task()
             ...
             : *reinterpret_cast<::hddt::ComputeTask *>(
...
inline void Task::unsafe_arena_set_allocated_compute_task(
...
inline ::hddt::ComputeTask *Task::_internal_mutable_compute_task() {
  if (!_internal_has_compute_task()) {
    ...
    set_has_compute_task();
    task_type_.compute_task_ =
        CreateMaybeMessage<::hddt::ComputeTask>(GetArena());
  }
...
inline bool Task::has_sync_task() const { return _internal_has_sync_task(); }
inline void Task::set_has_sync_task() { _oneof_case_[0] = kSyncTask; }
...
inline const ::hddt::SynchronizationTask &Task::_internal_sync_task() const {
  return _internal_has_sync_task()
             ...
             : *reinterpret_cast<::hddt::SynchronizationTask *>(
...
inline void Task::unsafe_arena_set_allocated_sync_task(
...
inline ::hddt::SynchronizationTask *Task::_internal_mutable_sync_task() {
  if (!_internal_has_sync_task()) {
    ...
    set_has_sync_task();
    task_type_.sync_task_ =
        CreateMaybeMessage<::hddt::SynchronizationTask>(GetArena());
  }
...
inline ::PROTOBUF_NAMESPACE_ID::int64
Task::_internal_estimated_duration() const {
...
inline void
Task::_internal_set_estimated_duration(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
inline void Task::clear_has_task_type() { _oneof_case_[0] = TASK_TYPE_NOT_SET; }
...
// repeated .hddt.Task tasks = 1;
inline int TaskChain::_internal_tasks_size() const { return tasks_.size(); }
inline int TaskChain::tasks_size() const { return _internal_tasks_size(); }
inline void TaskChain::clear_tasks() { tasks_.Clear(); }
...
inline ::hddt::Task *TaskChain::_internal_add_tasks() { return tasks_.Add(); }
...
// int32 chain_id = 2;
inline void TaskChain::clear_chain_id() { chain_id_ = 0; }
...
inline void
TaskChain::_internal_set_chain_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
// int64 priority = 3;
inline void TaskChain::clear_priority() { priority_ = PROTOBUF_LONGLONG(0); }
...
inline void
TaskChain::_internal_set_priority(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
// int32 rank = 1;
inline void ComputationGraph_RankAssignment::clear_rank() { rank_ = 0; }
inline ::PROTOBUF_NAMESPACE_ID::int32
ComputationGraph_RankAssignment::_internal_rank() const {
  return rank_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32
ComputationGraph_RankAssignment::rank() const {
  // @@protoc_insertion_point(field_get:hddt.ComputationGraph.RankAssignment.rank)
  return _internal_rank();
}
inline void ComputationGraph_RankAssignment::_internal_set_rank(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {

  rank_ = value;
}
inline void ComputationGraph_RankAssignment::set_rank(
    ::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_rank(value);
...
inline void ComputationGraph_RankAssignment::clear_chains() { chains_.Clear(); }
inline ::hddt::TaskChain *
ComputationGraph_RankAssignment::mutable_chains(int index) {
...
inline const ::hddt::TaskChain &
ComputationGraph_RankAssignment::_internal_chains(int index) const {
  return chains_.Get(index);
}
inline const ::hddt::TaskChain &
ComputationGraph_RankAssignment::chains(int index) const {
  // @@protoc_insertion_point(field_get:hddt.ComputationGraph.RankAssignment.chains)
  return _internal_chains(index);
}
inline ::hddt::TaskChain *
ComputationGraph_RankAssignment::_internal_add_chains() {
  return chains_.Add();
}
...
// map<int32, int32> dependency_map = 3;
inline int
ComputationGraph_RankAssignment::_internal_dependency_map_size() const {
...
inline const ::PROTOBUF_NAMESPACE_ID::Map<::PROTOBUF_NAMESPACE_ID::int32,
                                          ::PROTOBUF_NAMESPACE_ID::int32> &
...
inline ::PROTOBUF_NAMESPACE_ID::Map<::PROTOBUF_NAMESPACE_ID::int32,
                                    ::PROTOBUF_NAMESPACE_ID::int32> *
...
inline void ComputationGraph::clear_assignments() { assignments_.Clear(); }
inline ::hddt::ComputationGraph_RankAssignment *
ComputationGraph::mutable_assignments(int index) {
...
inline const ::hddt::ComputationGraph_RankAssignment &
ComputationGraph::_internal_assignments(int index) const {
  return assignments_.Get(index);
}
inline const ::hddt::ComputationGraph_RankAssignment &
ComputationGraph::assignments(int index) const {
  // @@protoc_insertion_point(field_get:hddt.ComputationGraph.assignments)
  return _internal_assignments(index);
}
inline ::hddt::ComputationGraph_RankAssignment *
ComputationGraph::_internal_add_assignments() {
  return assignments_.Add();
}
inline ::hddt::ComputationGraph_RankAssignment *
ComputationGraph::add_assignments() {
...
inline ::PROTOBUF_NAMESPACE_ID::int64
ComputationGraph::_internal_graph_version() const {
...
inline void ComputationGraph::_internal_set_graph_version(
    ::PROTOBUF_NAMESPACE_ID::int64 value) {

  graph_version_ = value;
}
inline void
ComputationGraph::set_graph_version(::PROTOBUF_NAMESPACE_ID::int64 value) {
...
template <>
struct is_proto_enum<::hddt::ComputeTask_OperatorType> : ::std::true_type {};
template <>
inline const EnumDescriptor *
GetEnumDescriptor<::hddt::ComputeTask_OperatorType>() {
